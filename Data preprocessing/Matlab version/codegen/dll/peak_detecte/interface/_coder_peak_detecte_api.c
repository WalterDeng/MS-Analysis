...
static real_T c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *scanF,
                                 ...
                                 const char_T *identifier)
{
  ...
  y = d_emlrt_marshallIn(sp, emlrtAlias(scanF), &thisId);
  emlrtDestroyArray(&scanF);
  return y;
}
...
void peak_detecte_api(const mxArray *const prhs[2], const mxArray **plhs)
{
  ...
  emlrt_marshallIn(&st, emlrtAlias(prhs_copy_idx_0), "data", data);
  scanF = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "scanF");
  /* Invoke the target function */
  peak_detecte(data, scanF, peaks_info);
  /* Marshall function outputs */
  peaks_info->canFreeData = false;
  *plhs = emlrt_marshallOut(peaks_info);
...
void peak_detecte_atexit(void)
{
  ...
  peak_detecte_xil_terminate();
  peak_detecte_xil_shutdown();
...
/* End of code generation (_coder_peak_detecte_api.c) */
