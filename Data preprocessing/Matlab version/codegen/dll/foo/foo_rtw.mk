...
## 
## Makefile     : foo_rtw.mk
## Generated on : Wed Mar 02 15:13:27 2022
## Final product: ./foo.dll
...
SRCS = $(START_DIR)/codegen/dll/foo/foo_data.c $(START_DIR)/codegen/dll/foo/foo_initialize.c $(START_DIR)/codegen/dll/foo/foo_terminate.c $(START_DIR)/codegen/dll/foo/foo.c
...
OBJS = foo_data.obj foo_initialize.obj foo_terminate.obj foo.obj
...
%.obj : $(START_DIR)/codegen/dll/foo/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/dll/foo/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
foo_data.obj : $(START_DIR)/codegen/dll/foo/foo_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


foo_initialize.obj : $(START_DIR)/codegen/dll/foo/foo_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


foo_terminate.obj : $(START_DIR)/codegen/dll/foo/foo_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


foo.obj : $(START_DIR)/codegen/dll/foo/foo.c
	$(CC) $(CFLAGS) -o "$@" "$<"
